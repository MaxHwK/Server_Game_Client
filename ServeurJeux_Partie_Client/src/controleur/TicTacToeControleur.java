...
public class TicTacToeControleur {
    ...
    public void finDePartie(int x, int y) throws RemoteException {
    ...
    public void debutPartie(){
        try{
            ...
            lblPartie.setText("Debut de la partie. Tour du joueur " + joueur + " Symbole [" + joueurs[joueur] + "]");
        } catch(Exception e) {
            lblPartie.setText(e.getMessage());
        }
    }
